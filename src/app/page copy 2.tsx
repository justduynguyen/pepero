...
//     if (existingItem) {
//       // If it exists, update quantity (Context handles removal if hits 0)
...
//     if (existingItem) {
//       // Update Addon Quantity directly using the specific Context method
...
//         };
//         // Create a dummy product wrapper for the addon
...
//         <div className='bg-gradient-to-b from-gray-50 via-white to-gray-50 backdrop-blur-3xl rounded-b-[40px] border-b border-gray-200/50 shadow-[0_10px_30px_-10px_rgba(0,0,0,0.05)]'>
...
//             <div className='relative h-[280px] sm:h-[380px] w-full overflow-hidden group'>
//               {/* Image - Scales on Hover */}
//               <Image src='/imgs/Demo.jpg' alt='Pepero Set' fill className='object-cover transition-transform duration-1000 group-hover:scale-105' priority />
...
//               {/* Float Badge */}
//               <div className='absolute top-4 right-4 bg-white/90 backdrop-blur-md text-rose-500 text-xs font-black px-3 py-1.5 rounded-full shadow-sm border border-rose-100 flex items-center gap-1 z-10'>
...
//               <div className='mb-6'>
//                 {/* Negative margin top to pull it closer to the line above if needed, or just keep tight leading */}
//                 <h2 className='text-3xl md:text-4xl font-black leading-tight'>
//                   <span className='text-transparent bg-clip-text bg-gradient-to-r from-rose-500 to-pink-600'>Pepero Tự Làm</span>
//                 </h2>
//                 <p className='text-gray-500 text-sm font-medium max-w-md mx-auto leading-relaxed mt-3'>
//                   Tự tay làm 15 que bánh ngọt ngào! Đầy đủ nguyên liệu & dụng cụ, chỉ cần làm theo hướng dẫn là xinh ngay! ✨
//                 </p>
//               </div>
...
//                     <div className='w-10 h-10 bg-white rounded-2xl shadow-sm flex items-center justify-center text-xl border border-rose-100'>🥨</div>
...
//                   {/* Grid Item 4 */}
//                   <div className='flex flex-col items-center text-center gap-1'>
//                     <div className='w-10 h-10 bg-white rounded-2xl shadow-sm flex items-center justify-center text-xl border border-rose-100'>🛍️</div>
//                     <span className='text-[11px] font-bold text-gray-600 leading-tight'>
//                       15 Túi
//                       <br />
//                       Đựng
...
//                   <span className='px-3 py-1.5 rounded-full bg-[#5D4037] text-xs font-bold text-white shadow-sm'>🖤 Cacao</span>
...
//         {/* PRODUCT LIST (SETS) - SECTION 1 (THE HERO) */}
//         <section className='space-y-4'>
//           {/* NEW: BOLD GRADIENT HEADER for Step 1 */}
//           {/* sticky top-[88px]  */}
//           <div className='z-30 flex justify-center mb-6 -mx-4 sm:mx-0'>
//             {/* Using a strong gradient background to make this stand out more than Step 2 */}
//             <div className='inline-flex items-center gap-3 bg-gradient-to-r from-rose-500 to-pink-600 px-8 py-3.5 rounded-full shadow-xl shadow-rose-500/30 border-2 border-white/20 backdrop-blur-md animate-in fade-in slide-in-from-top-4 duration-500'>
//               {/* <span className="bg-white text-rose-600 w-8 h-8 rounded-full flex items-center justify-center text-lg font-black shadow-sm">
//                 1
//               </span> */}
//               <h3 className='text-lg sm:text-xl font-black text-white tracking-wide drop-shadow-md'>Chọn Set Charm 🍢</h3>
//             </div>
//           </div>

//           {/* CONTAINER: Increased opacity and border strength */}
//           <div className='bg-white/60 backdrop-blur-md border-[3px] border-dashed border-rose-300/80 rounded-[2.5rem] p-3 sm:p-6 relative overflow-hidden shadow-sm'>
//             {/* Background decoration */}
//             <div className='absolute top-0 left-1/2 -translate-x-1/2 w-full h-full bg-gradient-to-b from-rose-100/40 to-transparent pointer-events-none'></div>

//             <div className='grid grid-cols-2 gap-3 sm:grid-cols-2 sm:gap-6 relative z-10'>
...
//                       isSelected
//                         ? 'ring-[3px] ring-rose-500 bg-rose-50 shadow-xl shadow-rose-200 scale-[1.02]'
//                         : 'hover:shadow-lg hover:-translate-y-1 border border-rose-100'
//                     }`}>
...
//                       {isSelected && (
//                         <div className='absolute top-2 right-2 bg-rose-500 text-white text-[10px] font-bold px-2.5 py-1 rounded-full shadow-md animate-in zoom-in'>
//                           Đã chọn
//                         </div>
//                       )}
//                     </div>
...
//                       {/* Price Tag floating */}
//                       <div className='mb-2'>
//                         <h4 className='font-bold text-gray-900 text-sm sm:text-lg line-clamp-1 leading-tight'>{charmSet.name}</h4>
//                         <p className='font-extrabold text-rose-500 text-base'>{product.basePrice.toLocaleString()}đ</p>
//                       </div>

//                       {/* Charms */}
//                       <div className='flex items-center gap-1.5 mb-4 overflow-x-auto hide-scrollbar py-1'>
//                         {charmSet.charms.map(c => (
//                           <div
//                             key={c.id}
//                             className='flex flex-col items-center justify-center w-7 h-7 bg-white rounded-md shadow-sm border border-rose-100 text-sm shrink-0'>
//                             {c.emoji}
//                           </div>
//                         ))}
//                       </div>
...
//                       {/* Controls */}
//                       <div
//                         className={`mt-auto flex items-center justify-between rounded-full p-1 border transition-colors ${
//                           isSelected ? 'bg-white border-rose-200' : 'bg-gray-50 border-gray-200'
//                         }`}>
//                         <motion.button
//                           whileTap={{ scale: 0.9 }}
//                           onClick={() => handleSetChange(charmSet.id, -1)}
//                           disabled={quantity === 0}
//                           className='w-8 h-8 rounded-full bg-white shadow-sm flex items-center justify-center text-gray-600 disabled:opacity-30 disabled:shadow-none border border-gray-100'>
//                           <svg className='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
//                             <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M20 12H4' />
//                           </svg>
//                         </motion.button>

//                         <div className='font-black text-gray-900 w-6 text-center text-lg'>{quantity}</div>

//                         <motion.button
//                           whileTap={{ scale: 0.9 }}
//                           onClick={() => handleSetChange(charmSet.id, 1)}
//                           className='w-8 h-8 rounded-full bg-rose-500 text-white shadow-md flex items-center justify-center hover:bg-rose-600 border border-rose-600'>
//                           <svg className='w-4 h-4' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
...
//           {/* SUBTLE WHITE HEADER for Step 2 - Keeps it secondary */}
//           <div className='flex justify-center mb-2'>
//             <div className='inline-flex items-center gap-3 bg-white/90 border border-yellow-200 px-6 py-2.5 rounded-full shadow-sm'>
//               {/* <span className="bg-yellow-100 text-yellow-600 w-6 h-6 rounded-full flex items-center justify-center text-xs font-bold">
//                 2
//               </span> */}
//               <h3 className='text-base font-bold text-gray-600'>Mua thêm</h3>
//             </div>
//           </div>

//           {/* CONTAINER: Lighter border than products */}
//           <div className='bg-white/40 backdrop-blur-sm border-2 border-dashed border-yellow-200/50 rounded-[2rem] p-4 relative overflow-hidden'>
...
//                       isSelected ? 'bg-yellow-50 ring-1 ring-yellow-300' : 'bg-white hover:bg-gray-50'
//                     }`}>
//                     <div className='flex items-center gap-3'>
//                       <div
//                         className={`w-12 h-12 rounded-xl flex items-center justify-center text-2xl shadow-sm transition-colors ${
//                           isSelected ? 'bg-yellow-200 text-yellow-700' : 'bg-gray-100 text-gray-400 grayscale opacity-70'
//                         }`}>
//                         🎁
//                       </div>
//                       <div>
...
//                       <button
//                         onClick={() => handleAddOnChange(addOn.id, 1)}
//                         className='w-7 h-7 rounded-lg bg-yellow-400 text-white shadow-sm flex items-center justify-center hover:bg-yellow-500'>
//                         +
//                       </button>
//                     </div>
//                   </div>
...
//                   <span>Xem Giỏ</span>
//                   <span className='text-[10px] opacity-80 font-medium'>({cart.totalItems} món)</span>
//                 </span>
